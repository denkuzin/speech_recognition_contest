...
FLAGS.background_volume = (0.1, 0.3)  # 0.1
FLAGS.background_frequency = (0.4, 0.8)   # 0.8
FLAGS.silence_percentage = 10.0
FLAGS.unknown_percentage = (10.0, 20.0) #10
FLAGS.time_shift_ms = 100     #100
FLAGS.testing_percentage = 5 #10
FLAGS.validation_percentage = 5 #10
FLAGS.sample_rate = 16000
FLAGS.clip_duration_ms = 1000
FLAGS.window_size_ms = 30.0
FLAGS.window_stride_ms = 10.0
FLAGS.dct_coefficient_count = 40   # 40
